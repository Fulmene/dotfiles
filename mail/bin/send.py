...
def main(argv):
    ...
    client_id = keyring.get_password('Login', 'gmail_client_id')
    client_secret = keyring.get_password('Login', 'gmail_client_secret')
...
def build_accounts(config):
    ...
    for section in acct_sections:
        ...
        refresh_token = keyring.get_password('Login', '{0}_refresh_token'.format(section.split(' ')[1]))
